...
public class UserService : IUserService
{
    ...
    public async Task<List<Track>> GetUserTopTracks(string username)
    {
        var key = "1766bd528b32b4e1ab0dc6324067fd8a";
        var url =
            $"https://ws.audioscrobbler.com/2.0/?method=user.gettoptracks&user={username}&api_key={key}&format=json";
